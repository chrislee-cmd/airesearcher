...
- 섹션 구성 (오직 아래만 허용):
  0. \`개인정보 수집 동의\` — **반드시 첫 번째 섹션**. 단일 \`single_choice\` 질문 (제목: "개인정보 수집 및 이용 동의", 옵션: "동의합니다" / "동의하지 않습니다", required). description 에 수집 항목/목적/보유 기간/거부 권리 명시. 누락 시 post-process 가 자동 삽입하므로 LLM 도 생성 권장 (수집 항목과 목적을 brief 에 맞게 조정 가능).
