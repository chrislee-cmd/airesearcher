...
function triggerClass(tone: 'ghost' | 'primary', open: boolean): string {
  const base =
    'inline-flex items-center gap-1.5 px-3 py-1.5 text-[11px] font-semibold uppercase tracking-[0.18em] transition-colors duration-[120ms] rounded-sm disabled:cursor-not-allowed disabled:opacity-50';
  if (tone === 'primary') {
