          ...
          {isSuperAdmin && (
            <>
              ...
              <PopoverLink
                href="/writing-system"
                onClick={() => {
                  track('admin_writing_system_open_click');
                  setOpen(false);
                }}
              >
                {t('adminWritingSystem')}
              </PopoverLink>
              <PopoverLink
                href="/admin/qa-feedback"
                onClick={() => {
                  track('admin_qa_feedback_open_click');
                  setOpen(false);
                }}
              >
                {t('adminQaFeedback')}
              ...
              <PopoverLink
                href="/admin/recruiting-invitations"
                onClick={() => {
                  track('admin_recruiting_invitations_open_click');
                  setOpen(false);
                }}
              >
