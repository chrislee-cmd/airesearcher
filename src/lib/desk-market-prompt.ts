...
const MARKET_BUCKET_HEADING: Record<MarketBucket, string> = {
  stats: '📊 산업 통계 (KOSIS · aTFIS · ECOS) + 글로벌 매크로 (World Bank · OECD, 한국+G7 GDP·산업 대비 기준선 — "국내 vs G7 대비" 섹션 근거) — TAM 근거',
...
[필수 출력 구조 — 아래 7개 H2 heading 을 순서·아이콘·표 형식 그대로 따릅니다. 표는 반드시 GFM 파이프 표(\`| … |\` + \`|---|\` 구분선)로 씁니다.]
