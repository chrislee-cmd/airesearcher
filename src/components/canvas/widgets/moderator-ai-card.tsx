...
// key 는 내부 식별자라 'moderator_ai' 유지 (표시 라벨만 AI UT). 현재
// placeholder — 카드 안은 짧은 "준비 중", 전체보기는 기능 소개 hero
...
export const moderatorAiCard: WidgetContent = {
  ...
  meta: {
    ...
    accent: 'mint',
    cost: 0,
    description: 'AI가 사용성 테스트(UT)를 대신 진행해요',
  },
  state: 'idle',
  ExpandedBody: () => (
    <ComingSoonBody
      ...
      icon="🧪"
      title="AI UT가 곧 만나요"
      description="가이드라인과 실시간 대화 컨텍스트를 바탕으로 AI가 자동으로 사용성 테스트(UT)를 진행해요. 동시통역과 프로빙 어시스턴트가 하나로."
      features={[
        '가이드라인 기반 자동 질문 진행',
