    ...
    .array(
      z.object({
        title: z
          .string()
          .describe(
            '섹션명. 스크리너 설문이므로 본 조사형 섹션(사용 경험/구매 행태/만족도 등)은 만들지 말 것. 도메인 스크리닝 섹션만: "기본 정보", "자격 조건", "동의 및 일정". "개인정보 수집 동의" / "인적사항" 은 시스템이 자동 삽입하므로 만들지 말 것.',
          ),
        questions: z.array(surveyQuestionSchema),
      }),
    )
    .describe(
      '스크리너 설문 — 도메인 스크리닝 섹션만 1~3개. 본 조사용 섹션 금지. "개인정보 수집 동의"(첫 섹션) 와 "인적사항"(마지막 섹션) 은 시스템이 자동으로 붙이므로 생성 금지.',
    ),
});
