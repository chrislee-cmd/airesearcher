    ...
    <div className="mx-auto max-w-[1120px] px-2 pb-16 pt-8">
      <div className="flex items-center justify-between gap-4 border-b border-line pb-3">
        ...
        <a
          ...
          className="shrink-0 border border-ink bg-ink px-3 py-1.5 text-[11px] font-semibold uppercase tracking-[0.18em] text-paper transition-colors duration-[120ms] hover:bg-ink-2 rounded-sm"
        >
          {t('inquiry')}
        </a>
      </div>
      ...
      <div className="mt-8 flex justify-center">
        <a
          ...
          target="_blank"
          rel="noopener noreferrer"
          className="border border-ink bg-ink px-6 py-3 text-[12px] font-semibold uppercase tracking-[0.2em] text-paper transition-colors duration-[120ms] hover:bg-ink-2 rounded-sm"
        >
          {t('inquiry')} →
        </a>
      </div>
