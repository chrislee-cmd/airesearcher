...
export async function POST(
  ...
  // Uses the *requesting user's* Google token (below), so we keep `user` — the
  // access gate opens the route to super-admin OR org member, and the batch must
  // belong to an owner the caller may touch (tenancy scoping).
