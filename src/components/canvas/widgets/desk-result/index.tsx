...
// market 은 TAM/SAM 참고 데이터 뷰(MarketDataset — disclaimer + DeskReportView),
// 그 외(trend + 옛 custom job row)는 공용 markdown 리포트(DeskReportView)로
// 분기한다. custom mode 는 제거됐지만 옛 job row 는 여기서 graceful 하게 렌더된다.
