// 동시접속 정원 게이트 — 좀비 정리 백스톱(cron).
//
// primary sweep 은 admit_or_enqueue RPC 안의 lazy sweep(매 ping) 이다. 하지만
// ping 이 뜸한 순간(모든 active 가 조용, 대기자 없음)엔 좀비 슬롯이 TTL 넘겨
// 살아있어 다음 대기자의 입장을 늦출 수 있다. 이 cron 이 1분 주기로 백스톱:
// TTL 지난 active/queue 행을 무조건 회수해 슬롯을 푼다.
//
